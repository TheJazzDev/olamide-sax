        ...
        >
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
            ...
            <div className="text-white">
              ...
              >
                <span className="inline-block pt-8 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-xs sm:text-sm font-bold rounded-full mb-4 sm:mb-6 shadow-lg shadow-[#c9a227]/30 hover:shadow-xl hover:shadow-[#c9a227]/50 transition-all">
