...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section ref={heroRef} className="relative h-screen flex items-center overflow-hidden bg-gradient-to-br from-[#0a0a0f] via-[#1a1a2e] to-[#0f0f1e]">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center h-full">
            ...
            <div className="text-white text-center lg:text-left pt-4 lg:pt-0">
              ...
              >
                <Link
                  href="/media"
                  className="group inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 md:px-8 md:py-4 bg-gradient-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-sm sm:text-base font-bold rounded-full hover:shadow-2xl hover:shadow-[#c9a227]/50 transition-all hover:scale-105 shadow-xl"
                >
      ...
      <section ref={introRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 v left-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#c9a227]/5 rounded-full blur-3xl" />
