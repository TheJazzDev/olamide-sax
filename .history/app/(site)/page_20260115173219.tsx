...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-[95vh] flex items-center overflow-hidden bg-gradient-to-br from-[#0a0a0f] via-[#1a1a2e] to-[#0f0f1e]">
        ...
        <motion.div
          className="container-custom relative z-10 py-8 sm:py-12 md:py-16"
          style={{ opacity: heroOpacity, scale: heroScale }}
        >
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center pt-8">
            {/* Hero Content */}
            <div className="text-white">
              ...
              >
                <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-xs sm:text-sm font-bold rounded-full mb-4 sm:mb-6 shadow-lg shadow-[#c9a227]/30 hover:shadow-xl hover:shadow-[#c9a227]/50 transition-all">
              ...
              >
                ...
                <motion.span
                  className="block bg-gradient-to-r from-[#c9a227] via-[#e8d48b] to-[#c9a227] bg-clip-text text-transparent"
              ...
              <motion.p
                className="text-sm sm:text-base text-gray-300 leading-relaxed mb-6 sm:mb-8 max-w-2xl"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Link
                  href="/media"
                  className="group inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 bg-gradient-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-sm sm:text-base font-bold rounded-full hover:shadow-2xl hover:shadow-[#c9a227]/50 transition-all hover:scale-105 shadow-xl"
                >
                ...
                <Link
                  href="/music"
                  className="group inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 border-2 border-[#c9a227] text-[#c9a227] text-sm sm:text-base font-bold rounded-full hover:bg-[#c9a227] hover:text-[#0a0a0f] transition-all hover:scale-105 backdrop-blur-sm"
                >
                  <Headphones className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" />
                  Listen to Music
                </Link>
              </motion.div>
            </div>
            ...
            >
              <div className="relative aspect-[3/4] max-w-lg mx-auto">
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-[#c9a227] to-[#d4ac3a] rounded-3xl blur-2xl opacity-30"
                  animate={{
                    scale: [1, 1.05, 1],
                    rotate: [0, 5, 0]
                  }}
      ...
      <section ref={introRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
        {/* Decorative elements */}
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.div className="inline-block mb-4 sm:mb-6" variants={fadeInUp}>
              ...
              <div className="w-16 sm:w-20 h-1 bg-gradient-to-r from-[#c9a227] to-[#e8d48b] mx-auto mt-2" />
            </motion.div>
            <motion.h2
            ...
            <motion.div variants={fadeInUp}>
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 md:px-7 md:py-3.5 bg-gradient-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-sm sm:text-base font-bold rounded-full hover:shadow-2xl hover:shadow-[#c9a227]/50 transition-all hover:scale-105 shadow-xl group"
              >
      ...
      <section ref={skillsRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white relative overflow-hidden">
        ...
        >
          ...
          >
            {/* Saxophone */}
            <motion.div
              className="group bg-gradient-to-br from-white to-gray-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-[#c9a227]/20 transition-all duration-300 border-2 border-gray-100 hover:border-[#c9a227] hover:-translate-y-3"
              variants={scaleIn}
              whileHover={{ y: -10 }}
            >
              <motion.div
                className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#c9a227] to-[#d4ac3a] rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg"
      ...
      <section ref={featuredRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#16213e] text-white relative overflow-hidden">
        {/* Background Effects */}
        <div className="absolute inset-0">
          <motion.div
        ...
        >
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-center">
            <motion.div variants={fadeInUp}>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-white to-[#c9a227] bg-clip-text text-transparent">
            ...
            >
              <div className="relative aspect-[4/3] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl shadow-[#c9a227]/10 border-2 border-[#c9a227]/20 group">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a1a2e]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <motion.div whileHover={{ y: -3 }} transition={{ duration: 0.2 }}>
              <Link
                href="/media"
                className="block group p-5 sm:p-6 md:p-8 bg-gradient-to-br from-white to-gray-50 rounded-xl sm:rounded-2xl transition-all duration-300 shadow-sm hover:shadow-xl border border-gray-100 hover:border-[#c9a227]/50"
              >
      ...
      {/* CTA Section */}
      <section className="py-10 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-[#c9a227] via-[#d4ac3a] to-[#c9a227] relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute inset-0">
          <motion.div
