...
export default function MediaPage() {
  ...
  return (
    <>
        ...
        <div className='container-custom'>
          <div className='max-w-3xl'>
            ...
            <p className='text-base sm:text-lg md:text-xl text-gray-300'>
              Watch performances, listen to music, and explore the visual
              journey of Olamide Sax
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Content */}
      <section className='pt-4 lg:pt-10 bg-gray-50'>
        <div className='container-custom'>
          {loading ? (
                    ...
                    <div className='flex flex-wrap gap-2 sm:gap-3'>
                      {videoCategories.map((cat) => (
                        <button
                          ...
                          className={`px-4 py-2 sm:px-5 sm:py-2.5 text-sm sm:text-base font-medium rounded-full transition-colors ${
                                ...
                                {video.category && (
                                  <>
                                    ...
                                    <span className='text-xs font-medium text-gray-600'>
                                      {video.category === 'SAXOPHONE' &&
                                        'Saxophone'}
                                      {video.category === 'VOCAL' && 'Vocal'}
                                      {video.category === 'KEYBOARD' &&
                                        'Keyboard'}
                                    </span>
                                  </>
                                )}
                              </div>
                              <h3 className='font-bold text-gray-900 mt-1 mb-2 text-sm sm:text-base'>
                                {video.title}
                              </h3>
                              {video.description && (
                      ...
                      <div className='bg-white p-12 sm:p-16 rounded-xl text-center'>
                        ...
                        <p className='text-gray-600 text-sm sm:text-base'>
                          {videoCategory !== 'all'
                            ...
                            : 'Check back soon for performance videos and recordings.'}
                        </p>
                      </div>
                    )
                  ) : (
                ...
                <div>
                  {music.length > 0 ? (
                          ...
                          <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4'>
                            ...
                            <div className='flex-1 min-w-0'>
                              ...
                              <div className='flex items-center gap-2 mt-1'>
                                <span className='text-xs sm:text-sm font-medium text-[#c9a227]'>
                                  {release.platform}
                                </span>
                    ...
                    <div className='bg-white p-12 sm:p-16 rounded-xl text-center'>
                      ...
                      <p className='text-gray-600 text-sm sm:text-base'>
                        Check back soon for music releases and streaming links.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div>
                  {photos.length > 0 ? (
                    ...
                    <div className='bg-white p-12 sm:p-16 rounded-xl text-center'>
                      ...
                      <p className='text-gray-600 text-sm sm:text-base'>
                        Check back soon for performance and event photos.
                      </p>
                    </div>
                  )}
                </div>
      ...
      <section className='py-12 sm:py-16 md:py-20 bg-[#c9a227]'>
        <div className='container-custom text-center'>
          ...
          <p className='text-[#1a1a2e]/80 text-base sm:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto'>
            Experience live performances and bring the magic of Olamide Sax to
            your next event.
          </p>
          <Link
            href='/contact'
