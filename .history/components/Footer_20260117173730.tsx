...
export default function Footer() {
  return (
    <footer className="bg-linear-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#16213e] text-white relative overflow-hidden pt-8 sm:pt-10 md:pt-12 lg:pt-14">
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
          ...
          <div>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center px-4 py-2 sm:px-5 sm:py-2.5 bg-linear-to-r from-[#c9a227] to-[#d4ac3a] text-[#0a0a0f] text-xs sm:text-sm font-bold rounded-full hover:bg-[#e8d48b] transition-all hover:scale-105 shadow-xl hover:shadow-2xl"
            >
              Book for Events
            </Link>
          </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/10 relative z-10 mt-8 sm:mt-10 md:mt-12 lg:mt-14 px-4">
        <div className="py-5 sm:py-6 md:py-8 pb-6 sm:pb-8 md:pb-10">
