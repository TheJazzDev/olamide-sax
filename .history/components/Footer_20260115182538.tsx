...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#16213e] text-white relative overflow-hidden py-10  lg:py-14">
      ...
      <div className="border-t border-white/10 relative z-10 mt-10 sm:mt-12 md:mt-14 lg:mt-16">
        <div className="container-custo py-6 sm:py-8 pb-8 sm:pb-10 md:pb-12">
