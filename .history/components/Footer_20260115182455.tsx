...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#16213e] text-white relative overflow-hidden py-10 sm:py-12 sm:pb-0 md:py-14 md:pb-0 lg:pt-16 lg:pb-0">
