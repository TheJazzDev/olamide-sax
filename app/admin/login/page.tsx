...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // The password is: olamide2024
    if (password === 'olamide2024') {
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-12 py-3 rounded-lg border border-gray-200 focus:border-[#c9a227] focus:ring-2 focus:ring-[#c9a227]/20 outline-none transition-colors"
