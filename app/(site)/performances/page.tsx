...
export const metadata: Metadata = {
  ...
  description:
    'Explore the career highlights and notable performances of Olamide Sax, including appearances at Black History Month celebrations and performances for the Mayor of Doncaster.',
};
...
const highlights = [
  {
    ...
    description:
      'Performed at the official Black History Month celebrations, showcasing African contemporary and gospel music to a diverse audience.',
    icon: Calendar,
  },
  {
    ...
    location: 'Doncaster, UK',
    description:
      'Entertained the Mayor of Doncaster and senior council leaders at a prestigious public cultural event.',
    icon: Award,
  },
  {
    ...
    location: 'Doncaster, UK',
    description:
      'Lead performer at Black and Minority Ethnic (BME) United Doncaster community events, promoting cultural unity through music.',
    icon: Users,
  },
  {
    ...
    description:
      'Regular live gospel and worship performances at community centres, churches, and faith-based gatherings.',
    icon: Music,
  },
];
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              <p className='text-gray-600 leading-relaxed mb-6'>
                One of Olamide Sax&apos;s most prestigious engagements was
                performing at a public cultural event attended by the{' '}
                <strong>Mayor of Doncaster</strong> and distinguished council
                leaders. This performance showcased his ability to captivate
                high-profile audiences with his unique blend of African
                contemporary and gospel music.
              </p>
              <p className='text-gray-600 leading-relaxed mb-8'>
                The event highlighted his contribution to cultural engagement in
                the UK and demonstrated his professionalism and artistic
                excellence on a significant public stage.
              </p>
        ...
        <div className='container-custom'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Notable performances and achievements throughout Olamide
              Sax&apos;s musical career
            </p>
          </div>
            ...
            {highlights.map((highlight, index) => (
              <div
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    <h3 className='text-lg sm:text-xl font-bold text-[#1a1a2e] mb-2'>
                      {highlight.title}
                    </h3>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-gray-300 leading-relaxed mb-6'>
                As the{' '}
                <strong className='text-white'>Founder and Lead Artist</strong>{' '}
                of Lammy Wonder Music, Olamide Sax leads a professional music
                band that delivers exceptional live performances across multiple
                genres and venues.
              </p>
              <ul className='space-y-4 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  ...
                  <span className='text-gray-300'>
                    Repertoire-based interpretations of global musical works
                  </span>
                </li>
              </ul>
              <Link
            ...
            <div className='relative'>
              <div className='bg-[#c9a227]/10 p-8 rounded-2xl border border-[#c9a227]/30'>
                <h3 className='text-xl sm:text-2xl font-bold mb-6'>Services Offered</h3>
      ...
      <section className='section-padding bg-white'>
        <div className='container-custom'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='text-lg sm:text-xl md:text-2xl text-gray-700 leading-relaxed mb-8 italic'>
              Olamide Sax brings an incredible energy to every performance. His
              ability to connect with audiences through his music is truly
              remarkable.
            </p>
            <p className='text-gray-500'>
              — Event Organizer, BME United Doncaster
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='py-20 bg-[#c9a227]'>
        <div className='container-custom text-center'>
          ...
          <p className='text-[#1a1a2e]/80 text-lg mb-8 max-w-2xl mx-auto'>
            Whether it&apos;s a wedding, corporate event, church service, or
            cultural celebration, Olamide Sax delivers unforgettable musical
            experiences.
          </p>
          <Link
            href='/contact'
