...
export const metadata: Metadata = {
  ...
  description:
    'Read about Olamide Sax in community and cultural publications, highlighting his contribution to music and cultural engagement in the UK.',
};
  ...
  return (
    <>
        ...
        <div className='container-custom'>
          <div className='max-w-3xl'>
            ...
            <p className='text-base sm:text-lg md:text-xl text-gray-300'>
              Media coverage and features highlighting Olamide Sax&apos;s
              contribution to music and cultural engagement
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='container-custom'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='text-lg text-gray-600 leading-relaxed'>
              Olamide Sax&apos;s work has been featured in community and
              cultural platforms, highlighting his contribution to music,
              cultural engagement, and live performance in the UK.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-custom'>
          <h2 className='text-xl sm:text-2xl md:text-3xl font-bold text-[#1a1a2e] mb-10 text-center'>
            Featured Coverage
          </h2>
                  ...
                  <article
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div className='flex-1'>
                        ...
                        <h3 className='text-lg sm:text-xl font-bold text-[#1a1a2e] mt-1 mb-3'>
                          {item.title}
                        </h3>
                        {item.excerpt && (
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto'>
            <div className='p-6 bg-gray-50 rounded-xl'>
              ...
              <p className='text-gray-600 text-sm'>
                Featured performer at Doncaster&apos;s Black History Month
                celebrations.
              </p>
            </div>
            ...
            <div className='p-6 bg-gray-50 rounded-xl'>
              ...
              <p className='text-gray-600 text-sm'>
                Regular performer at community cultural events promoting
      ...
      <section className='section-padding bg-[#1a1a2e] text-white'>
        <div className='container-custom'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <blockquote className='text-xl sm:text-2xl md:text-3xl font-light leading-relaxed mb-6 italic'>
              &ldquo;Music is a universal language that transcends borders and
              brings people together. Through my performances, I aim to share
              the rich heritage of African music while creating meaningful
              connections with audiences.&rdquo;
            </blockquote>
            <cite className='text-[#c9a227] font-semibold not-italic'>
              — Olamide Sax
            </cite>
          </div>
        </div>
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-custom'>
          <div className='max-w-2xl mx-auto text-center'>
            <h2 className='text-xl sm:text-2xl md:text-3xl font-bold text-[#1a1a2e] mb-6'>
              Media Enquiries
            </h2>
            <p className='text-gray-600 mb-8'>
              For press enquiries, interviews, or media features, please get in
              touch.
            </p>
            <Link
              href='/contact'
