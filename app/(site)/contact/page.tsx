  ...
  return (
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            {/* Contact Details */}
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1a1a2e] mb-6 sm:mb-8">
                Let&apos;s Connect
              </h2>
            ...
            <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-2xl">
              <h2 className="text-lg sm:text-xl font-bold text-[#1a1a2e] mb-4 sm:mb-6">
                Send a Message
              </h2>
              ...
              <form className="space-y-4 sm:space-y-6">
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#c9a227] focus:ring-2 focus:ring-[#c9a227]/20 outline-none transition-colors text-gray-900 placeholder:text-gray-400"
                ...
                <div>
                  ...
                  <select
                    ...
                    name="subject"
                    required
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#c9a227] focus:ring-2 focus:ring-[#c9a227]/20 outline-none transition-colors bg-white text-gray-900"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#c9a227] focus:ring-2 focus:ring-[#c9a227]/20 outline-none transition-colors resize-none text-gray-900 placeholder:text-gray-400"
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1a1a2e] mb-6 sm:mb-8 text-center">
            Available For
          </h2>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-[#1a1a2e] text-white">
        <div className="container-custom text-center">
          ...
          <a
            href="mailto:Olaniyanolamidephillip@gmail.com"
            className="inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 bg-[#c9a227] text-[#1a1a2e] text-sm sm:text-base font-semibold rounded-full hover:bg-[#e8d48b] transition-colors"
          >
